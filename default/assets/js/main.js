!(function (t) {
    ...
    t(".navbar .navbar-nav li a:not(.dropdown-toggle), .navbar .appointment-btn").on("click", function (o) {
        var n = t(this);
        t("html, body")
            .stop()
            .animate({
        ...
        t(document).on("click", ".navbar-collapse.show", function (o) {
            if (t(o.target).is("a") && t(o.target).hasClass("dropdown-toggle")) {
                return; // Don't close if it's a dropdown toggle
            }
            t(o.target).is("a") && t(this).collapse("hide");
        }),
        t(".navbar .navbar-nav li a:not(.dropdown-toggle)").on("click", function () {
